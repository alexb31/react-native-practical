...
import { getAllRoadtrips } from "../../store/actions/index";

class AllRoadTrip extends Component {
  ...
  const mapDispatchToProps = dispatch => {
    return {
      onLoadPlaces: () => dispatch(getAllRoadtrips())
    };
  };
  
  console.log("mapStateToProps: " + mapStateToProps)
  
  export default connect(mapStateToProps, mapDispatchToProps)(AllRoadTrip);